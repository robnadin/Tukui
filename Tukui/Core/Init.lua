...
Engine[1].Mult = 768 / string.match(Engine[1].Resolution, "%d+x(%d+)") / GetCVar("uiScale")
Engine[1].Scale = function(x) return Engine[1].Mult * math.floor(x / Engine[1].Mult + .5) end
...
Engine[1].WelcomeMessage = "|cffff8000Tukui Classic "..Engine[1].Version.." Beta|r - /tukui help"
